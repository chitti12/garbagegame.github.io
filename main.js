document.addEventListener('DOMContentLoaded', () => {
    ...
    themeSong.src = 'sounds/sounds_gb-theme.mp3'
    themeSong.volume = .5
    let garbageUp = document.createElement('audio')
    garbageUp.src = 'sounds/sounds_garbage-up.mp3'
    garbageUp.volume = .5
    let stageSound = document.createElement('audio')
    stageSound.src = 'sounds/sounds_stage-end.mp3'
    stageSound.volume = .5
    let ratSound = document.createElement('audio')
    ratSound.src = 'sounds/sounds_rat-hit.mp3'
    ratSound.volume = .5

    /*----- Create sprites -----*/
    let garbageImg = new Image()
    garbageImg.src = 'img/bin.png'
    let gbImg = new Image()
